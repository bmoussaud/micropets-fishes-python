...
```json
{
  "projectName" : "micropets-fish-python"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [python-web-app->micropets-fish-pytho...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [: python-web-app->: micropets-fish-pyt...(truncated)]
